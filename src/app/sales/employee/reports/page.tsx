...
const REPORT_LINKS = [
  ...
  { href: "/sales/employee/analytics/revenue", label: "Revenue report" },
  { href: "/sales/employee/analytics/lead-source", label: "Lead-source report" },
  { href: "/sales/employee/analytics/lost-deals", label: "Lost-deal report" },
];

export default async function SalesReportsPage() {
  const staff = await requireSalesPage("reports.reports");
