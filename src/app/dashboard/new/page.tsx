  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-10">
        ...
        <div className="mt-4 overflow-hidden rounded-[24px] border border-[var(--dash-border)] bg-[var(--dash-surface)] p-4 sm:p-6 md:p-8">
          ...
          <h1 className="font-archivo mt-4 text-xl uppercase tracking-tighter text-[var(--dash-text)] sm:text-3xl">
            Add a referral
          </h1>
