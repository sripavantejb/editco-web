...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none relative z-10 flex flex-1 flex-col items-center justify-center px-4 pt-24 pb-28 sm:px-6">
        <div className="relative flex w-full max-w-5xl flex-col items-center">
          ...
          >
            <h1 className="w-full max-w-full select-none overflow-hidden font-archivo text-[22vw] font-black uppercase leading-[0.82] tracking-[-0.06em] text-white sm:text-[22vw] md:text-[20vw] md:leading-[0.78] lg:text-[18vw] xl:text-[17vw]">
              <span className="bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent">
                EDITCO
              </span>
            </h1>

            <div className="mt-6 flex w-full flex-col items-center sm:mt-8 md:mt-10">
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.5 }}
                className="max-w-[22rem] px-1 font-space-grotesk text-[0.85rem] font-medium leading-snug tracking-tight text-white/85 sm:max-w-xl sm:text-[clamp(0.85rem,1.85vw,1.35rem)] sm:leading-snug md:max-w-3xl md:whitespace-nowrap md:leading-none"
              >
              ...
              >
                <div className="flex w-full max-w-md flex-col items-center gap-3 px-1 sm:max-w-none sm:flex-row sm:justify-center sm:gap-6 sm:px-4">
                  <button
                    ...
                    className="pointer-events-auto group relative flex h-12 w-full cursor-pointer items-center justify-center overflow-hidden rounded-full border border-gaude-orange bg-gaude-orange px-6 font-archivo text-[10px] font-bold uppercase tracking-widest text-white transition-all hover:shadow-[0_0_30px_rgba(255,78,0,0.4)] sm:h-16 sm:w-auto sm:px-10 md:text-[11px]"
                  >
                    Book a Call
                  </button>
                  <a
